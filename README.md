...
| :---------------------- | :---------------------- | :---------------------- | :---------------------- |
| [Система рекомендации друзей](DE_Data_Lake) | DE | Социальная сеть панирует внедрить функционал рекомендации другей, основанный на геоданных | *Python, PySpark, Airflow, HDFS* |
